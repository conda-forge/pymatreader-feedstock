...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymatreader-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15037&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymatreader-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymatreader` can be installed with:

```
conda install pymatreader
```

It is possible to list all of the versions of `pymatreader` available on your platform with:
